...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "radarr:Notifications/notification:Notification":
                return new Notification(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationBoxcar:NotificationBoxcar":
                return new NotificationBoxcar(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationCustomScript:NotificationCustomScript":
                return new NotificationCustomScript(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationDiscord:NotificationDiscord":
                return new NotificationDiscord(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationEmail:NotificationEmail":
                return new NotificationEmail(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationEmby:NotificationEmby":
                return new NotificationEmby(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationGotify:NotificationGotify":
                return new NotificationGotify(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationJoin:NotificationJoin":
                return new NotificationJoin(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationKodi:NotificationKodi":
                return new NotificationKodi(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationMailgun:NotificationMailgun":
                return new NotificationMailgun(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationNotifiarr:NotificationNotifiarr":
                return new NotificationNotifiarr(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationNtfy:NotificationNtfy":
                return new NotificationNtfy(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationPlex:NotificationPlex":
                return new NotificationPlex(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationProwl:NotificationProwl":
                return new NotificationProwl(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationPushbullet:NotificationPushbullet":
                return new NotificationPushbullet(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationPushover:NotificationPushover":
                return new NotificationPushover(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationSendgrid:NotificationSendgrid":
                return new NotificationSendgrid(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationSimplepush:NotificationSimplepush":
                return new NotificationSimplepush(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationSlack:NotificationSlack":
                return new NotificationSlack(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationSynologyIndexer:NotificationSynologyIndexer":
                return new NotificationSynologyIndexer(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationTelegram:NotificationTelegram":
                return new NotificationTelegram(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationTrakt:NotificationTrakt":
                return new NotificationTrakt(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationTwitter:NotificationTwitter":
                return new NotificationTwitter(name, <any>undefined, { urn })
            case "radarr:Notifications/notificationWebhook:NotificationWebhook":
...
pulumi.runtime.registerResourceModule("radarr", "Notifications/notification", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationBoxcar", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationCustomScript", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationDiscord", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationEmail", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationEmby", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationGotify", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationJoin", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationKodi", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationMailgun", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationNotifiarr", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationNtfy", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationPlex", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationProwl", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationPushbullet", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationPushover", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationSendgrid", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationSimplepush", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationSlack", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationSynologyIndexer", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationTelegram", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationTrakt", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationTwitter", _module)
pulumi.runtime.registerResourceModule("radarr", "Notifications/notificationWebhook", _module)
