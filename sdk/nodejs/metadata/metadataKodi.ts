...
export class MetadataKodi extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'radarr:Metadata/metadataKodi:MetadataKodi';
     ...
     */
    public readonly addCollectionName!: pulumi.Output<boolean>;
    /**
     * Enable flag.
     */
    ...
    constructor(name: string, argsOrState?: MetadataKodiArgs | MetadataKodiState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["addCollectionName"] = state ? state.addCollectionName : undefined;
            ...
            if ((!args || args.addCollectionName === undefined) && !opts.urn) {
                throw new Error("Missing required property 'addCollectionName'");
            }
            ...
            resourceInputs["addCollectionName"] = args ? args.addCollectionName : undefined;
...
export interface MetadataKodiState {
     ...
     * Add collection name flag.
     */
    addCollectionName?: pulumi.Input<boolean>;
    /**
     * Enable flag.
     */
