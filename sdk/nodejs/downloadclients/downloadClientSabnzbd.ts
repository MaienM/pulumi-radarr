 ...
 *
 * const example = new radarr.downloadclients.DownloadClientSabnzbd("example", {
 *     apiKey: "test",
 *     enable: true,
 *     host: "sabnzbd",
 *     name: "Example",
 ...
 *
 * ```sh
 *  $ pulumi import radarr:DownloadClients/downloadClientSabnzbd:DownloadClientSabnzbd example 1
 * ```
 */
export class DownloadClientSabnzbd extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'radarr:DownloadClients/downloadClientSabnzbd:DownloadClientSabnzbd';
