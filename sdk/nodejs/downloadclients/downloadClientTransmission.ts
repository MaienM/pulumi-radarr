 ...
 *
 * const example = new radarr.downloadclients.DownloadClientTransmission("example", {
 *     enable: true,
 *     host: "transmission",
 *     name: "Example",
 *     port: 9091,
 ...
 *
 * ```sh
 *  $ pulumi import radarr:DownloadClients/downloadClientTransmission:DownloadClientTransmission example 1
 * ```
 */
export class DownloadClientTransmission extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'radarr:DownloadClients/downloadClientTransmission:DownloadClientTransmission';
