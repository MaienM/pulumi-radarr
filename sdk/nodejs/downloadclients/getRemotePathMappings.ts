 ...
 *
 * const example = radarr.DownloadClients.getRemotePathMappings({});
 * ```
 */
export function getRemotePathMappings(opts?: pulumi.InvokeOptions): Promise<GetRemotePathMappingsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("radarr:DownloadClients/getRemotePathMappings:getRemotePathMappings", {
    }, opts);
}
