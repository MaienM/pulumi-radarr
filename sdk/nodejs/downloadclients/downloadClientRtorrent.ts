 ...
 *
 * const example = new radarr.downloadclients.DownloadClientRtorrent("example", {
 *     enable: true,
 *     host: "rtorrent",
 *     name: "Example",
 *     port: 9091,
 ...
 *
 * ```sh
 *  $ pulumi import radarr:DownloadClients/downloadClientRtorrent:DownloadClientRtorrent example 1
 * ```
 */
export class DownloadClientRtorrent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'radarr:DownloadClients/downloadClientRtorrent:DownloadClientRtorrent';
