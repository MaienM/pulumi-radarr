 ...
 *
 * const example = new radarr.downloadclients.DownloadClientUsenetDownloadStation("example", {
 *     enable: true,
 ...
 *
 * ```sh
 *  $ pulumi import radarr:DownloadClients/downloadClientUsenetDownloadStation:DownloadClientUsenetDownloadStation example 1
 * ```
 */
export class DownloadClientUsenetDownloadStation extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'radarr:DownloadClients/downloadClientUsenetDownloadStation:DownloadClientUsenetDownloadStation';
