...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "radarr:MediaManagement/mediaManagement:MediaManagement":
                return new MediaManagement(name, <any>undefined, { urn })
            case "radarr:MediaManagement/naming:Naming":
                return new Naming(name, <any>undefined, { urn })
            case "radarr:MediaManagement/rootFolder:RootFolder":
...
pulumi.runtime.registerResourceModule("radarr", "MediaManagement/mediaManagement", _module)
pulumi.runtime.registerResourceModule("radarr", "MediaManagement/naming", _module)
pulumi.runtime.registerResourceModule("radarr", "MediaManagement/rootFolder", _module)
