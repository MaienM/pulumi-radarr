...
replace github.com/devopsarr/terraform-provider-radarr/shim => ./shim
...
require (
	...
	github.com/devopsarr/radarr-go v0.1.0 // indirect
	github.com/devopsarr/terraform-provider-radarr v1.8.0 // indirect
