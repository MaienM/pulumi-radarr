...
func convertName(tfname string) (module string, name string) {
	contract.Assertf(strings.HasPrefix(tfname, "radarr_"), "Invalid snake case name %s. Does not start with radarr_", tfname)
	tfname = strings.TrimPrefix(tfname, "radarr_")
...
func makeResource(res string) tokens.Type {
	...
	return tfbridge.MakeResource("radarr", mod, name)
}
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Description:       "A Pulumi package for creating and managing Radarr resources",
